...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for A-List Hub - How we collect, use, and protect your personal information when using our Narcos Life platform.',
  keywords: 'privacy policy, data protection, personal information, A-List Hub, narcos life',
  openGraph: {
    title: 'Privacy Policy | A-List Hub',
    description:
      'Privacy Policy for A-List Hub - How we collect, use, and protect your personal information.',
    type: 'website'
  },
  robots: {
    index: true,
...
export default function PrivacyPolicyPage() {
  ...
  const dataTypes = [
    {
      ...
      description:
        'Username, avatar, email address, and Discord ID (via Discord OAuth scopes: identify, email)',
      icon: '👤',
      required: true
    },
    {
      title: 'Usage Analytics',
      description: 'Page views, feature usage, and diagnostic performance metrics',
      icon: '📊',
      required: false
    },
    {
    ...
    },
    {
      ...
      description: 'IP address, browser type, device information, and session metadata',
      icon: '💻',
      required: false
    }
  ]
  ...
  const protectionMeasures = [
    ...
    },
    {
      ...
      description:
        'We use Discord OAuth 2.0 for secure authentication without storing passwords or sensitive credentials.',
      icon: Shield
    },
    {
      title: 'Data Minimization',
      description:
        'We only collect and store the minimum amount of data necessary to provide our services effectively.',
      icon: Database
    },
    {
      title: 'Regular Security Audits',
      description:
        'Our systems undergo regular security reviews and updates to maintain the highest protection standards.',
      icon: Eye
    }
  ]
  ...
  const sections = [
    {
      ...
      content: [
        ...
        'Automatically collected information includes usage data, device information, and basic analytics to improve our service.',
    ...
    },
    {
      ...
      content: [
        ...
        'Inactive accounts may be deleted after extended periods of non-use in line with our retention policy.',
    ...
    },
    {
      ...
      content: [
        'Depending on your region, you may have rights including access, correction, deletion, objection, restriction, or portability.',
        ...
        'We can provide a copy of your data in a machine-readable format upon request.',
    ...
    },
    {
      ...
      content: [
        ...
        'We rely on our providers’ data processing terms to help protect your privacy.'
      ]
    },
    {
      ...
      content: [
        ...
        'We strive to follow applicable privacy laws (such as GDPR and CCPA) and rely on our providers’ safeguards for cross-border transfers.',
        'Appropriate contractual or technical measures are in place where applicable to protect your information during these transfers.',
        'You have the right to be informed about and, where applicable, object to international data transfers.'
      ]
    },
    {
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto mb-4">
            Your privacy matters to us. This policy clearly explains how we collect, use, and protect your information.
          </p>
