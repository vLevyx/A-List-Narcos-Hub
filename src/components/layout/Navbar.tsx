            ...
            {loading ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-3 bg-background-secondary/50 hover:bg-background-secondary/80 rounded-lg px-3 py-2 transition-all duration-200 border border-white/10 hover:border-accent-primary/30"
                >
                  <div className="relative">
                    {!avatarLoaded && (
                ...
                {isMenuOpen && (
                  <div
                    ref={menuRef}
                    className="absolute right-0 mt-2 w-64 bg-background-secondary rounded-lg shadow-xl border border-white/10 py-2 z-50"
                  >
              ...
              <Button onClick={signInWithDiscord} size="sm">
                Sign In
              </Button>
            )}
          </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              {loading ? (
                ...
                <div className="flex flex-col space-y-2 px-2 pt-4 border-t border-white/10">
                  ...
                  <button
                    onClick={handleSignOut}
                    className="flex items-center text-red-400 hover:text-red-300 py-2 text-sm"
                  >
                ...
                <div className="px-2">
                  <Button onClick={signInWithDiscord} size="sm" className="w-full">
