...
const features = [
  ...
  },
  {
    ...
    description: "Complete license pricing information",
    href: "/license-prices",
  ...
  {
    title: "Store Prices",
    description: "Market prices and item availability",
    href: "/store-prices",
    requiresAccess: false,
  },
  {
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm font-medium text-purple-300">Premium Gaming Tools</span>
            </div>
